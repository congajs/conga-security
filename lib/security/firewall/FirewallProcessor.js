...
class FirewallProcessor {
    ...
    getPreAuthToken() {
        const stopwatch = this.stopwatch &&
            this.stopwatch.start('security.firewall.pre_authenticate', 'security');
        if (!this.firewall ||
    ...
    authenticateToken(token, realm) {
        const stopwatch = this.stopwatch &&
            this.stopwatch.start('security.firewall.authenticate', 'security');
    ...
    validateToken(token) {
        ...
        const stopwatch = this.stopwatch &&
            this.stopwatch.start('security.firewall.validate', 'security');
    ...
    process() {
        const stopwatch = this.stopwatch && 
            this.stopwatch.start('security.firewall.processor', 'security');
