...
class BassEncryptListener {
    ...
    onPreUpdate(event, cb) {
        ...
        if (resource.__loadedData !== undefined && resource.__loadedData[ this.field ] !== resource[ this.field ]) {
     ...
     */
    encrypt(resource, cb) {
        this.encryption.encrypt(resource, resource[ this.field ]).then(encrypted => {
